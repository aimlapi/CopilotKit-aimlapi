...
Anything that exposes an **OpenAI-compatible** API, including [aimlapi.com](https://aimlapi.com),
[OpenRouter](https://openrouter.ai), a self-hosted gateway, an internal LLM proxy, [Ollama](https://ollama.com),
[Together](https://together.ai), [Groq](https://groq.com), [Novita](https://novita.ai), or your own fine-tuned endpoint, works through the same
